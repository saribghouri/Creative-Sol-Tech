          ...
          >
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                ></motion.div>
                <span className="text-yellow-500 font-medium tracking-wider">GET IN TOUCH</span>
              </div>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              <div className="flex gap-4">
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  href="#"
                  className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-yellow-500 transition-colors duration-300"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-500"
                    required
                  />
                </motion.div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <motion.div whileHover={{ scale: 1.02 }} transition={{ type: "spring", stiffness: 300 }}>
                  ...
                  <div className="flex">
                    <select className="px-3 py-3 bg-gray-800 border border-gray-700 rounded-l-lg text-white border-r-0 focus:ring-2 focus:ring-yellow-500 focus:border-transparent">
                      <option>🇵🇰 +92</option>
                      <option>🇺🇸 +1</option>
                      <option>🇬🇧 +44</option>
                    </select>
                    <input
                      ...
                      className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-r-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-500"
                      required
                    />
                  </div>
                </motion.div>
              ...
              <motion.div whileHover={{ scale: 1.01 }} transition={{ type: "spring", stiffness: 300 }}>
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all duration-300 text-white placeholder-gray-500 resize-none"
                  required
                ></textarea>
              </motion.div>
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                type="submit"
                className="w-full bg-yellow-500 hover:bg-yellow-600 text-black font-semibold py-4 px-6 rounded-lg transition-all duration-300 flex items-center justify-center gap-2"
              >
                Send Message
                <motion.span
                  animate={{ x: [0, 5, 0] }}
